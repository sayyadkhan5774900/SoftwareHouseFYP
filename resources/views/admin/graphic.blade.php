  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="{{url('Dashboard-2')}}">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{url('graphic')}}">Graphic Designing</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('website')}}">Website Development</a></li>
                 <li class="nav-item"> <a class="nav-link" href="{{url('product')}}">Product Photography</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{url('event')}}">Event Management</a></li>
                   <li class="nav-item"> <a class="nav-link" href="{{url('social')}}">Social Media</a></li>
       ...
       <!--    <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{url('graphic')}}">Buttons</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{url('addneworder')}}">
...
<p class='text-justify'>They are groomed to acquire a certain classic set of skills (which today demand a facility with software) including drawing, photography, composition and typography — the design and structural characteristics of letterforms, arguably graphic design’s lingua franca.</p>
  ...
  <footer class="footer footer-02 bg-dark">
      
      <div class="footer-bottom">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 text-center text-md-left">
              <a href="{{url('index')}}"><img class="img-fluid footer-logo" src="images/main/logow.png" alt="" style="width: 50%;"></a>
            </div>
            ...
            <div class="col-md-5 text-center copyright text-md-right">
              <p class="mb-0 text-white"> &copy; Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> <a href="{{url('index')}}"> Socio Tech</a> All Rights Reserved</p>
            </div>
          </div>
        </div>
      </div>
