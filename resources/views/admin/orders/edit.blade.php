    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact') ? 'is-invalid' : '' }}" type="text" name="contact" id="contact" value="{{ old('contact', $order->contact) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('service_provider') ? 'is-invalid' : '' }}" name="service_provider_id" id="service_provider_id">
                    @foreach($service_providers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('service_provider_id') ? old('service_provider_id') : $order->service_provider->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('deadline_date') ? 'is-invalid' : '' }}" type="text" name="deadline_date" id="deadline_date" value="{{ old('deadline_date', $order->deadline_date) }}">
