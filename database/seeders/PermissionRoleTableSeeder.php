...
class PermissionRoleTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $client_permissions = $supper_admin_permissions->filter(function ($permission) {
            $client_permissions_array = ['order_create', 'order_edit' , 'order_update', 'order_delete', 'order_show', 'services_dropdown_access','add_new_order_access','client_active_order_access','profile_password_edit'];
        ...
        $provider_permissions = $supper_admin_permissions->filter(function ($permission) {
            $provider_permissions_array = ['add_new_service_access','my_service_access','profile_password_edit','service_create','service_edit' ,'service_update','service_delete', 'service_show'];
